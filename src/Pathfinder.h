...
typedef std::function<float(World* world, Position, std::vector<Position>, int)> PathfinderHeuristicFn;
...
namespace Dijkstra {
float Heuristic(World* world, Position current_position, std::vector<Position> goal_path, int goal_progress);
}
